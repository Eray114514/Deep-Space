...
## Black Hole Gravitational Slingshot Observatory

The packaged relativistic observatory under `assets/vendor/black-hole/` was
adapted from MakerJackie's **Black Hole Gravitational Slingshot Observatory**.
Its standalone interface and bridge additions are licensed under the MIT
License. Copyright (c) 2026 MakerJackie.

The underlying real-time relativistic renderer is derived from Eric Bruneton's
**Black Hole Shader**, licensed under the BSD 3-Clause License. Copyright (c)
2020 Eric Bruneton. The packaged star data is sourced from Gaia DR2 and
Tycho-2.

The complete MIT license and BSD notice/disclaimer are distributed beside the
assets as `MAKERJACKIE-LICENSE.txt` and `THIRD_PARTY_NOTICES.md`.
